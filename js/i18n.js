...
// Languages: English (default), Korean, Chinese, German, Finnish, Polish, Russian, Turkish
...
const TRANSLATIONS = {
  ...
  tr: {
    ...
    "recent.label": "PUBG kullanıcı adını gir",
    "recent.button": "14 günü tara",
    "recent.note": "Son 14 günde 3+ maçta sana zarar veren rakipleri gösterir.",
    "recent.helper": "Son maçlarını analiz eder, tekrar saldıranları öne çıkarır ve aldığın hasarı toplar.",
